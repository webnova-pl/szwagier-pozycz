...
export const metadata: Metadata = {
  ...
  description:
    "Wypożycz profesjonalny sprzęt budowlany i ogrodowy w atrakcyjnych cenach. Szeroki wybór narzędzi i urządzeń dostępnych od zaraz.",
  keywords:
    ...
    <main className="max-md:mt-4">
      ...
      <div className="flex justify-end p-4 fixed md:hidden bg-white bottom-0 w-full">
        <a
          ...
          className="bg-dark-100 text-center w-full text-white font-bold rounded-[40px] py-4 md:px-6 cursor-pointer max-md:w-full text-nowrap hover:bg-[#363636] transition-colors"
